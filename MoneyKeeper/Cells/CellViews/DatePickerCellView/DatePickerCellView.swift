...
final class DatePickerCellView: TextFieldCellView {
    ...
    override func configure(with viewModel: TextFieldCellViewModel) {
        super.configure(with: viewModel)
        
        guard let trueViewModel = viewModel as? DatePickerCellViewModel else {
            return
        }
        
        onDatePickerDonePressed = trueViewModel.onDatePickerDonePressed
    }
